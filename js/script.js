            ...
            if (first_occur >= 0) {
              ...
              keywords.forEach(function (keyword) {
                ...
                match_content = match_content.replace(
                  regS,
                  '<em class="search-result-keyword">$&</em>'
                );
              });
              str +=
                '<p class="search-result-content">' + match_content + "...</p>";
            }
            str += "</li>";
          }
        });
...
$$(function () {
  ...
  $$(document).on("click", function (e) {
    ...
    var createImage = function (e) {
      ...
      if (
        e.target.getAttribute("id") === "scan-big-img" ||
        (parent &&
          parent.getAttribute &&
          parent.getAttribute("id") === "scan-big-img")
      ) {
        var removeEl = document.getElementById("scan-big-img");
        removeEl && document.body.removeChild(removeEl);
        return;
      }

      var src = e.target.getAttribute("src") || "";
      if (!src || ~src.indexOf("images/random")) return;
      var el = document.getElementById("scan-big-img");
      el && document.body.removeChild(el);
      var div = document.createElement("div");
      div.setAttribute("id", "scan-big-img");
